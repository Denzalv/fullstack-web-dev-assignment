...
app.get("/hewan", (req, res) => {
  res
    .status(200)
    .send({ message: "success get data Pet", hewan: hewan }
  );
});
...
app.post("/hewan", middlewarePostChecker, (req, res) => {
  ...
  res
    .status(201)
    .send({ message: "success adding one Pet", hewan: data }
  );
});
...
app.delete("/hewan/:id", (req, res) => {
  ...
  res
    .status(200)
    .send({ message: `Hewan ${idHewan} is deleted` }
  );
});
