...
///uang masuk
gajiPokok = 5000000;
gajiBonus = gajiPokok * 0.1;
gajiLembur = gajiPokok * 0.05;

let uangMasuk = gajiPokok + gajiBonus + gajiLembur;
let uangKeluar = gundam + makan + kost + subscription;
const sisaGaji = uangMasuk - uangKeluar;
